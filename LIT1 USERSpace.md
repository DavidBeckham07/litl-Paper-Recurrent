...
![image-20201121111648050](D:\学习\Linux\课程\论文\image-20201121111648050.png)
...
![image-20201121121418636](D:\学习\Linux\课程\论文\image-20201121121418636.png)
...
![image-20201121122530860](D:\学习\Linux\课程\论文\image-20201121122530860.png)

重新make一下，发现原来的错误解决了，又来了新的错误：

![image-20201121122609409](D:\学习\Linux\课程\论文\image-20201121122609409.png)

出现`NUMA_NODES`的地方都出错了，说明这个变量可能没有定义。emmmm，那就我帮他定义一下吧，我又进去代码里面，帮作者定义了一个`NUMA_NODES`

![image-20201121124038188](D:\学习\Linux\课程\论文\image-20201121124038188.png)

这下再来make一次，果然又报错了，报错的地方又是`NUMA_NODES`,这个变量redefined了。好家伙，这个变量到底定义了没有呀，前面又说找不到，现在又说重复定义。

![image-20201121124153172](D:\学习\Linux\课程\论文\image-20201121124153172.png)

仔细看报错信息，发现在/include/topologh.y的第27行已经定义过了，于是，我就进去看看，到底是怎么回事。

![image-20201121124317698](D:\学习\Linux\课程\论文\image-20201121124317698.png)

一看，原来如此，NUMA_NODES被定义为空串，这怎么能行呢，怪不得一直报错，我这里就自作主张，给他定义为2。当然，之前在htlockepfl.h中自己添加的NUMA_NODES就要删掉了。

![image-20201121124523496](D:\学习\Linux\课程\论文\image-20201121124523496.png)

![image-20201121124415134](D:\学习\Linux\课程\论文\image-20201121124415134.png)

再来make一次，嘻嘻，终于成功啦。

![image-20201121124559086](D:\学习\Linux\课程\论文\image-20201121124559086.png)

这些新生成的sh文件，应该就是编译的结果吧。

![image-20201121124703487](D:\学习\Linux\课程\论文\image-20201121124703487.png)

### 测试部分

根据readme中的信息，我们可以用`./xxxxxxx.sh myprogram`的方式运行生成的锁，

![image-20201121125002738](D:\学习\Linux\课程\论文\image-20201121125002738.png)
...
![image-20201121130905476](D:\学习\Linux\课程\论文\image-20201121130905476.png)
...
![image-20201121132934327](D:\学习\Linux\课程\论文\image-20201121132934327.png)

比赛结束！

![image-20201121133008876](D:\学习\Linux\课程\论文\image-20201121133008876.png)

左边锁比右边锁快了2s多。再测试一下？

![image-20201121133236860](D:\学习\Linux\课程\论文\image-20201121133236860.png)
